...
class WGANGP():
    ...
    def _get_opzimizer_by_string(self, lr):
    ...
    def _init_adversarial(self):
        ...
        self.critic_model.compile(
            ...
            optimizer=self._get_opzimizer_by_string(self.critic_learning_rate),
        ...
        self.model.compile(
            optimizer=self._get_opzimizer_by_string(self.generator_learning_rate),
